  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center z-10 px-6">
        ...
        >
          <span className="inline-block tag animate-fade-in shimmer-bg" style={{ animationDelay: '0.1s' }}>
        ...
        >
          Creating <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400">beautiful</span> digital experiences
          
          {/* Decorative elements */}
          <span className="absolute -top-10 -right-10 text-6xl text-purple-200/30 dark:text-purple-500/20 font-light rotate-12">{`{ }`}</span>
          <span className="absolute -bottom-8 -left-6 text-5xl text-blue-200/30 dark:text-blue-500/20 font-light rotate-[6deg]">/</span>
        </h1>
